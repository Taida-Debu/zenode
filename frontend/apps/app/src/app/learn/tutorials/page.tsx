                ...
                <div key={tutorial.id} className="glass-effect p-4 rounded-lg">
                  ...
                  <div className="flex items-center gap-4 mt-4">
                    <div className="flex items-center gap-2">
                      <ZenodeAvatar className="w-6 h-6 border-2 border-background" src={tutorial.instructor.avatar} seed={tutorial.instructor.fallback} name={tutorial.instructor.fallback} />
