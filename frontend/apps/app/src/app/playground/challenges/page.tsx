...
import { fetchActiveChallenges } from '@/lib/api/challenges'
...
export default function ChallengesPage() {
  ...
  useEffect(() => {
    const fetchChallenges = async () => {
      try {
        const challengesData = await fetchActiveChallenges();
                ...
                {challenges.map((challenge) => (
                  ...
                  >
                    ...
                    <div className="mt-4 flex items-center gap-2">
                      <div className="flex -space-x-2 rounded-full bg-zinc-950/90 px-0.5 py-0.5 ring-1 ring-white/10">
                        {Object.values(challenge.participants || {}).slice(0, 3).map((participant) => (
                          <div
                            key={participant.address}
                            className="shrink-0 rounded-full bg-zinc-800 ring-2 ring-zinc-950"
                          >
                            <ZenodeAvatar
