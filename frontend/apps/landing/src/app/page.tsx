...
import { StatCard, FeatureCard, WhyJoinCard, TestimonialCard } from '@zenode/ui/cards';
import { AppImage } from '@zenode/ui/app-image';
import { PartnerLogos } from '@zenode/ui/partner-logos';
      ...
      <div className="relative pt-32 bg-black">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 relative">
          <div className="text-center">
            ...
            <Link
              href={appPath('/dashboard/submit-proposal')}
