              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start gap-4">
                  <Avatar className="w-10 h-10">
                    <AvatarImage src="https://api.dicebear.com/9.x/identicon/svg?seed=alice" alt="Alice" />
                ...
                <div className="flex items-start gap-4">
                  <Avatar className="w-10 h-10">
                    <AvatarImage src="https://api.dicebear.com/9.x/identicon/svg?seed=bob" alt="Bob" />
                ...
                <div className="flex items-start gap-4">
                  <Avatar className="w-10 h-10">
                    <AvatarImage src="https://api.dicebear.com/9.x/identicon/svg?seed=carol" alt="Carol" />
